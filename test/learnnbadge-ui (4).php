    ...
    <div style="background:#111827;border:1px solid #1f2937;border-radius:16px;padding:1.5rem 2rem;max-width:480px;margin:0 auto 2rem;text-align:left;">
      ...
      <div style="display:flex;gap:6px;flex-wrap:wrap;">
        <button onclick="setNetwork('0xE76CAF6C344230f319D70f97F712a424E6b61B72','11155111')"
          style="background:rgba(99,102,241,0.1);border:1px solid rgba(99,102,241,0.3);color:#6366f1;padding:5px 12px;border-radius:6px;font-size:0.72rem;font-family:'Space Mono',monospace;cursor:pointer;">
          Sepolia
        </button>
        <button onclick="setNetwork('','1337')"
          style="background:rgba(52,211,153,0.1);border:1px solid rgba(52,211,153,0.3);color:#34d399;padding:5px 12px;border-radius:6px;font-size:0.72rem;font-family:'Space Mono',monospace;cursor:pointer;">
          LabChain (1337)
        </button>
        <button onclick="setNetwork('','31337')"
          style="background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.3);color:#f59e0b;padding:5px 12px;border-radius:6px;font-size:0.72rem;font-family:'Space Mono',monospace;cursor:pointer;">
          Hardhat (31337)
        </button>
      </div>
    </div>
