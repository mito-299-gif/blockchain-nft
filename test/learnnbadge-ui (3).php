          ...
          <div style="margin-bottom:1.4rem;">
            ...
            <div class="badge-presets">
              <button class="preset-btn"
                onclick="fillPreset('Blockchain Beginner','ผ่านการทดสอบพื้นฐาน Blockchain','🔗')">🔗 Blockchain
                Beginner</button>
              ...
              <button class="preset-btn" onclick="fillPreset('Web3 Explorer','สำรวจ Web3 ครบทุกด้าน','🌐')">🌐 Web3
                Explorer</button>
              <button class="preset-btn"
                onclick="fillPreset('Hackathon Winner','ชนะการแข่งขัน Blockchain 2026','🏆')">🏆 Hackathon
                Winner</button>
            </div>
          </div>
